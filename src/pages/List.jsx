    ...
    return (
        <div className="pt-12 pb-6 h-full transition-colors duration-300 bg-slate-50 dark:bg-slate-900 flex flex-col">
            ...
            <div ref={listRef} className="flex-1 min-h-[50vh] overflow-y-auto pr-10 pl-6 pb-24 hide-scrollbar relative" style={{ scrollbarGutter: 'stable' }}>
                ...
                {mode === 'all' && !searchTerm && (
                    <div className="fixed right-1.5 top-[235px] z-10 flex flex-col items-center justify-center py-2 px-0.5 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-full shadow-lg border border-slate-100 dark:border-slate-700">
                        {indexMarks.map(mark => (
                            <button
                                key={mark}
